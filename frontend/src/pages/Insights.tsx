          ...
          {loading || !insights ? (
            ...
            <IonGrid className="ion-no-padding">
              <IonRow>
                ...
                {/* Ratio de Gasto vs Ingreso */}
                <IonCol size="12" sizeMd="6" className="ion-padding-bottom">
                  <div className="glass-card ion-padding" style={{ height: '100%' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      <h3 style={{ margin: 0, fontSize: '16px', fontWeight: 600 }}>Tasa de Consumo</h3>
                  ...
                  <div className="glass-card ion-padding" style={{ height: '100%' }}>
                    ...
                    {insights.topCategories.length > 0 ? (
                      insights.topCategories.map((cat: any, i: number) => (
                        <div key={i} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px', paddingBottom: '12px', borderBottom: i < insights.topCategories.length - 1 ? '1px solid rgba(255,255,255,0.06)' : 'none' }}>
